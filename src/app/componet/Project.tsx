...
const Projects = () => {
  const projects = [
    ...
    },
    {
      id: 9,
      title: 'UI/UX Design',
      description: 'Using imagination and color to explore creativity! 🎨✨ This is my idea for a Kidloland design, which was influenced by the original game but updated with my own creative flair. For more images click on Unity Dev .',
      techStack: ['Figma', 'AI'],
      image: '/Kiddoland1.png',
      category: 'UI/Ux',
      codeLink: 'https://www.linkedin.com/posts/karan-mehta-b392232a7_gamedesign-leveldesign-indiegamedev-activity-7391810398376726528-KGrs?utm_source=social_share_send&utm_medium=member_desktop_web&rcm=ACoAAEnkxJ0BEriaxBPClujVSYI2sYqioS10akU',
      liveLink: 'https://www.linkedin.com/in/karan-mehta-b392232a7/',
    },
